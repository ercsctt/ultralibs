package uk.co.ericscott.ultralibs.title;
...
/**
 * Created by Mat from an old library class a good while ago.
 * <p>
 * Easy to use title class, create a new title and send it to the player, modify anything you need from
 * stay time to the colour of the title and subtitle.
 */
public class Title
{
    ...
    private ChatColor subtitleColor = ChatColor.DARK_AQUA;
    /* Title timings */
