...
/*
 * Copyright (c) Peavel Limited. All rights reserved.
 */
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable
{
    ...
    public boolean isInCuboid(final Player p) {
    ...
    /**
     * Check if the Cuboid contains only blocks of the given enums
     *
     * @param blockId - The block ID to check for
     * @return true if this Cuboid contains only blocks of the given enums
     */
